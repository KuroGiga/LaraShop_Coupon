        ...
        @if (sizeof(Cart::content()) > 0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="table-image"></td>
                        <td></td>
                        <td class="small-caps table-bg" style="text-align: right">Promo Code</td>
                        <td>{{ session()->get('coupons')['name'] }}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>${{ session()->get('coupons')['discount'] }}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    ...
                    $masuk = floatval(Cart::total());
                    $discount =  floatval(session()->get('coupons')['discount']);

                    
                    $hasil = $masuk - $discount;
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="table-bg">$<?php echo $hasil; ?>  </td>
                        <td class="column-spacer"></td>
                        <td></td>

                        <form action="{{ url('couponsR') }}" method="get">
                            <td><input name="coupon_code" id="coupon_code" style="height: 35px; border-radius: 5px;" type="text" placeholder="Enter Your Coupon Code">
            ...
            <div style="float:right; margin-left: 10px;">
                <form action="{{ url('/finish') }}" method="POST">
                    {!! csrf_field() !!}
                    <input type="hidden" name="_method" value="DELETE">
                    <input type="submit" class="btn btn-success btn-lg" value="Pay Cart">
                </form>
            </div>
